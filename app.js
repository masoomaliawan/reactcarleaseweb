...
const db = async () => {
    try {
        const conn = await mongoose.connect('mongodb://localhost:127.0.0.1:27017/autorizz', {
            // mongodb://127.0.0.1:27017/autorizz
...
app.post('/customer', async (req, res) => {
    ...
    const user = new UserModel({
        ...
        cardnum: req.body.usercard,
        cardcvc: req.body.usercvc,
        carddate: req.body.userdate
